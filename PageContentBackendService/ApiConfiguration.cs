...
using System;
using PageContentBackendService.App_Start;
...
using PageContentBackendService.Authentication;
using PageContentBackendService.Filters;
...
namespace PageContentBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "PageContentBackendService"))
                .EnableSwaggerUi();
